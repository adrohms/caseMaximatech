...
import com.maxima.geocrm.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void testUserToUserDTO() {
        ...
        authority.setPermissionName(AuthoritiesConstants.USER);
    ...
    void testAuthorityEquals() {
        ...
        authorityB.setPermissionName(AuthoritiesConstants.ADMIN);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityA.setPermissionName(AuthoritiesConstants.USER);
        assertThat(authorityA).isNotEqualTo(authorityB);

        authorityB.setPermissionName(AuthoritiesConstants.USER);
