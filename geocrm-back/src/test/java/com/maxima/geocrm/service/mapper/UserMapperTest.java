...
class UserMapperTest {
    ...
    void userDTOsToUsersWithAuthoritiesStringShouldMapToUsersWithAuthoritiesDomain() {
        ...
        assertThat(users.get(0).getAuthorities().iterator().next().getPermissionName()).isEqualTo("ADMIN");
    }
    ...
    void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(user.getAuthorities().iterator().next().getPermissionName()).isEqualTo("ADMIN");
    }
